...
Inconsistency_test = function(reward,cost,discount){
  ...
  ihyptie1 = filter(ihyptie1, vals >=max(vals))
  
  ihypdec1 = min(ihyptie1$period)
  ...
  expdec2 = ifelse(expdec1 == 1,1,min(exptie2$period))
  ...
  ihypdec2 = ifelse(ihypdec1 == 1,1,min(ihyptie2$period))
  ...
  chypdec2 = ifelse(chypdec1 == 1,1,min(chyptie2$period))
  ...
  expdec3 = ifelse(expdec1 == 1,1,
                   ifelse(expdec2 == 2,2,min(exptie3$period)))
 ...
 # Tie Catch
  ...
  ihypdec3 = ifelse(ihypdec2== 1,1,
                   ifelse(ihypdec2 == 2,2,min(ihyptie3$period)))
  ...
  chypdec3 = ifelse(chypdec1 == 1,1,
                   ifelse(chypdec2 == 2,2,min(chyptie3$period)))
...
Inconsistency_test(c(1,1,1,1),c(2,3,4,6),0.5)
