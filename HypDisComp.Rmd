...
Inconsistency_test = function(reward,cost,discount){
  ...
  ihypdec1 = which.max(c(rperiod1ihyp1,rperiod2ihyp1,rperiod3ihyp1,rperiod4ihyp1))
  ...
  chypdec1 = which.max(c(rperiod1chyp1,rperiod2chyp1,rperiod3chyp1,rperiod4chyp1))
  ...
  expdec2 = ifelse(expdec1 == 1,1,
                   which.max(c(NA,rperiod2ex2,rperiod3ex2,rperiod4ex2)))
  ...
  ihypdec2 = ifelse(ihypdec1 == 1,1,
                    which.max(c(NA,rperiod2ihyp2,rperiod3ihyp2,rperiod4ihyp2)))
  ...
  chypdec2 = ifelse(chypdec1 == 1,1,
                    which.max(c(NA,rperiod2chyp2,rperiod3chyp2,rperiod4chyp2)))
